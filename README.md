...
Diagrama E-R de la base de datos. NOTA: El archivo de la base de datos se encuentra en este mismo repositorio en la carpeta 'DB SQL Server', [Contribution guidelines for this project](/DB SQL Server)
